...
<div id="woocommerce-livechat-container">
    ...
    <div class="installation-desc">
        <p class="intro">
            Please <a href="https://my.livechatinc.com/subscription" target="_blank" class="a-important">log in to your LiveChat and subscribe</a> to continue chatting with your customers.
        </p>
